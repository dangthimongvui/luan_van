...
<body>
	...
	<div class="page-top-section">
		...
		<div class="container text-right">
			<div class="page-info">
				<h2>ĐĂNG KÍ LỊCH CHẤM THI</h2>
				<div class="page-links">
					<a href="../giang_vien/home.html">TRANG CHỦ</a>
					<span>ĐĂNG KÍ LỊCH CHẤM THI</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<form class="form-class" id="con_form">
					...
					<div class="col-sm-8">
						<button class="site-btn"><a href="../giang_vien/them_kh_cham_thi.php">THÊM KẾ HOẠCH</a></button>
					</div>
					<table class="col-md-12">
						...
						<?php
							...
							echo 
								"<tr>
									<form action='../../controllers/XOACHAMTHI_controller.php' method='POST'>
