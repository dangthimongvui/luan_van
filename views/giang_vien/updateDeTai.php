		...
		<div class="container" style="border-style: outset;>
			<div class="row">
				<div class="section-title dark">
					<h2> <span>UPDATE ĐỀ TÀI</span></h2>
				</div>
				<div class="col-md-12">
					<form class="form-class" id="con_form" action="../../controllers/updateDeTai.php" method="POST">
							<div class="row">
								<div class="col-md-12" >
									<b class="col-sm-12">Tên đề tài</b>
									<div class='col-sm-12' >
										<input type='text' name="TenDT" placeholder="Xây dựng website quản lý nhân sự Bệnh viên mắt Ánh"></input>
									</div>
								</div>
								<div class="col-md-12" >
							...
							<input type='hidden' name='MaDT' value='<?php echo $_GET["MaDT"]; ?>'></input>
							<div class="row">
