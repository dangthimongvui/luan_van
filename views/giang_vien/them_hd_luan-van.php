						...
						<form>
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-sm-12">
										<input type="text" name="ten_de_tai">
									</div>
								</div>

								<div class="col-md-12">
									<b class="col-sm-12">Mã số sinh viên</b>
									<div class="col-sm-12">
								...
								<div class="col-md-12">
									...
									<div class="col-sm-12">
										<select>
											<option type="text" class="form-control">Luận văn</option>
											<option  type="text" class="form-control">Tiểu luận</option>
											<option type="text" class="form-control">Đồ án</option>
										</select>
									</div>	
								</div>
								<div class="col-md-12">
