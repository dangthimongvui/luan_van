		...
		<div class="container" style="border-style: outset;>
			<div class="row">
				<div class="section-title dark">
					<h2> <span>THÊM HỌC PHẦN MỚI</span></h2>
				</div>
				<div class="col-md-12">
					<form class="form-class" id="con_form" action="../../controllers_admin/INSERT_HOCPHAN_controller.php" method="POST">
							<div class="row">
								<div class="col-md-12" >
									...
									<div class='col-sm-12' >
										<input type='text' name="MaHP" placeholder="Nhập mã học phần..."></input>
									</div>
								</div>
								<div class="col-md-12" >
									<b class="col-sm-12">Tên học phần</b>
									<div class='col-sm-12' >
										<input type='text' name="TenHP" placeholder="Nhập tên học phần..."></input>
									</div>
								</div>
								<div class="col-md-12" >
								...
								<div class="col-md-12" >
									...
									<div class='col-sm-12' >
										<select name="MonTQ">
											...
											echo "<option type='text' value=".$value["MaHP"]." class='form-control'>".$value["MaHP"]." - ".$value["TenHP"]."</option>";
										}
											?>
										</select>
									</div>
