	...
	<div class="container">
		<div class="row" style="border-style:outset;">
			<div class="section-title dark">
				<h2> <span>UPDATE NHÓM THỰC HÀNH</span></h2>
			</div>
			<div class="col-md-12">
					<form class="form-class" id="con_form" action="../../controllers_ad/update_thuc_hanh.php" method="POST">
							<div class="row">
								...
								<div class="col-md-12" >
									<b class="col-sm-12">Thực hiện</b>
									<div class='col-sm-2' >
										<a class="col-sm-2">Yes</a>
										<input class="col-sm-2" type='radio' name="ThucHien" value="Y"></input>
									</div>
									<div class='col-sm-2'>
										<a class="col-sm-2">No</a>
										<input class="col-sm-2" type='radio' name="ThucHien" value="N"></input>
									</div>
								</div>
								<input type='hidden' name='MaLop' value='<?php echo $_GET["id"]; ?>'></input>
