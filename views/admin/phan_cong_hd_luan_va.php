		...
		<div class="container">
			<div class="row">
				<div class="section-title dark">
					<h2> <span>PHÂN CÔNG HƯỚNG DẪN ĐỒ ÁN, TIỂU LUẬN, LUẬN VĂN</span></h2>
				</div>
				<div class="col-md-12">
	...
	<div class="newsletter-section spad">
		<div class="container">
			<div class="row">
				<form class="form-class" id="con_form">
					<div class="col-md-5">
						<h2>PHÂN CÔNG HƯỚNG DẪN LUẬN VĂN, TIỂU LUẬN, ĐỒ ÁN</h2>
					</div>
					<div class="col-sm-2">
						<select>
							<option type="text">Năm học</option>
					...
					<div class="col-sm-3">
						<button class="site-btn"><a href="../../views/qly_cap_khoa/them_hd_luan-van.html">THÊM KẾ HOẠCH</a></button>
					</div>
					<table class="col-md-12">
						...
						<tr>
							<td>1</td>
							<td name="ten_de_tai">avc</td>
							<td name="giang_vien">bi </td>
							<td name="mssv">1234</td>
							<td name="loai">luận văn</td>
							<td name="thoi_gian">Từ 1/4/2015 đến 8/12/2015</td>
							<td name="sua">Sửa</td>
							<td name="xoa">Xóa</td>
						</tr>
						<tr>
		...
		<div class="container">
			<div class="row">
				<form class="form-class" id="con_form">
					...
					<div class="col-sm-8">
						<button class="site-btn"><a href="../../views/qly_cap_khoa/co_van.html">THÊM KẾ HOẠCH</a></button>
					</div>
					<table class="col-md-12">
						<tr>
							<th>STT</th>
