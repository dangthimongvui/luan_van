...
<?php
    ...
    require("../../controllers_admin/getDN.controller.php");
    require("../../controllers/KHOA_controller.php");
    require("../../controllers/LOP_controller.php");
    require("../../controllers_admin/nganh_controller.php");
...
<div id="day" class="tabcontent">
  <div class="newsletter-section spad">
     <div class="col-sm-3">
          <button class="site-btn"><a href="../../views/admin/insert_taikhoan.php">THÊM MỚI</a></button>
        </div>
    <div class="container">
      <div class="row">
         <form class="form-class" id="con_form">
            ...
            <?php
              foreach ($dangnhap as $value){
                echo "
                <tr>
                <form action='../../controllers_admin/XOATAIKHOAN_controller.php' method='POST'>
                  <input name='username' value=".$value['Username']." style='display:none;'/>
                  <td>".$value["Username"]."</td>
                  <td>".$value["Password"]."</td>
                  <td>".$value["LoaiTK"]."</td>
                  <td><a href='../../views/admin/updatetaikhoan.php?Username=".$value['Username']."'>Update</a></td>
...
<div id="khoa" class="tabcontent">
  <div class="newsletter-section spad">
    <div class="col-sm-3">
      <button class="site-btn"><a href="../../views/admin/insert_khoa.php">THÊM MỚI</a></button>
    </div>
    <div class="container">
      <div class="row">
         <form class="form-class" id="con_form">
           ...
           <table class="col-md-12">
            ...
            <?php
              ...
              echo 
                "<tr>
                  <form action='../../controllers_admin/XOAKHOA_controller.php' method='POST'>
                  <input name='makhoa' value=".$row['MaKhoa']." style='display:none;'/>
                  <td>".$row["MaKhoa"]."</td>
                  <td>".$row["TenKhoa"]."</td>
                  <td><a href='../../views/admin/updatekhoa.php?MaKhoa=".$row['MaKhoa']."'>Update</a></td>
...
<div id="lop" class="tabcontent">
    <div class="newsletter-section spad">
      <div class="col-sm-3">
           <button class="site-btn"><a href=../../views/admin/insertLop.php>THÊM MỚI</a></button>
         </div>
    <div class="container">
      <div class="row">
        <form class="form-class" id="con_form">
          <table class="col-md-12">
            ...
            <?php
              ...
              echo 
                "<tr>
                  <form  action='../../controllers_admin/XOALOP_controller.php' method='POST'>
                  ...
                  <td>".$row["SiSo"]."</td>
                  <td>".$row["NienKhoa"]."</td>
                  <td><a href='../../views/admin/updatelop.php?MaLop=".$row['MaLop']."'>Update</a></td>
                  <td type='submit'><button>Xóa</button></td>
                  </form>
                </tr>";
              }
...
<div id="nganh" class="tabcontent">
  <div class="newsletter-section spad">
      <div class="col-sm-3">
           <button class="site-btn"><a href=../../views/admin/insert_nganh.php>THÊM MỚI</a></button>
         </div>
    <div class="container">
      <div class="row">
         <form class="form-class" id="con_form">
          <table class="col-md-12">
            ...
            echo "<tr>
              <form action='../../controllers_admin/XOANGANH_controller.php' method='POST'>
              <input name='manganh' value=".$row['MaNganh']." style='display:none;'/>
              <td>".$value["MaNganh"]."</td>
              <td>".$value["TenKhoa"]."</td>
              <td>".$value["TenNganh"]."</td>
              <td><a href='../../views/admin/updatenganh.php'>Update</a></td>
              <td><button type='submit'>Xóa</button></td>
              </form>
            </tr>";
                }
...
<div id="hocphan" class="tabcontent">
  <div class="newsletter-section spad">
     <div class="col-sm-3">
          <button class="site-btn"><a href="../../views/admin/insert_hocphan.php">THÊM MỚI</a></button>
        </div>
    <div class="container">
      <div class="row">
         <form class="form-class" id="con_form">
          <table class="col-md-12">
            ...
            echo "<tr>
              <form action='../../controllers_admin/XOAHOCPHAN_controller.php' method='POST'>
              ...
              <td>".$value["SoTCTH"]."</td>
              <td>".$value["MonTQ"]."</td>
              <td><a href='../../views/admin/updatehocphan.php'>Update</a></td>
              <td><button type='submit'>Xóa</button></td>
              </form>
            </tr>";
                }
