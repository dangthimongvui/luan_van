...
<div id="day" class="tabcontent">
  <div class="newsletter-section spad">
     <div class="col-sm-3">
          <button class="site-btn"><a href="../../views/qly_cap_khoa/them_kh_gday.php">THÊM KẾ HOẠCH MỚI</a></button>
        </div>
    <div class="container">
      <div class="row">
         <form class="form-class" id="con_form">
            ...
            <?php
              foreach ($alllophp as $value){
                echo "
                <tr>
                <form action='../../controllers_ad/XOADAY.php' method='POST'>
                  ...
                  <td><a href='../../views/ad/updateday.php?MaLHP=".$value['MaLHP']."'>Update</a></td>
...
<div id="coithi" class="tabcontent">
  <div class="newsletter-section spad">
    <div class="col-sm-3">
      <button class="site-btn"><a href="../../views/qly_cap_khoa/them_kh_coi_thi.php">THÊM KẾ HOẠCH MỚI</a></button>
    </div>
    <div class="container">
      <div class="row">
         <form class="form-class" id="con_form">
           ...
           <table class="col-md-12">
            ...
            <?php
              ...
              echo 
                "<tr>
                  <form action='../../controllers_ad/XOACOITHI.php' method='POST'>
                  ...
                  <td>".$row["CaThi"]."</td>
                  <td>".$row["HeSo"]."</td>
                  <td><a href='../../views/qly_cap_khoa/updatecoithi.php?id=" . $row['ID'] . "'>Update</a></td>
...
<div id="doan" class="tabcontent">
    <div class="newsletter-section spad">
      <div class="col-sm-3">
           <button class="site-btn"><a href=../qly_cap_khoa/them_detai.php>ĐĂNG KÍ ĐỀ TÀI</a></button>
         </div>
    <div class="container">
      <div class="row">
        <form class="form-class" id="con_form">
          <table class="col-md-12">
            ...
            <?php
              ...
              echo 
                "<tr>
                  <form action='../../controllers_ad/XOADETAI.php' method='POST'>
                  <input name='MaDT' value=".$row['MaDT']." style='display:none;'></input>
                  <td>".$row["TenDT"]."</td>
                  <td>".$row["Cap"]."</td>
                  <td>".$row["QDTiet"]."</td>
                  <td>".$row["TGianTH"]."</td>
                  <td><a href='../../views/qly_cap_khoa/updateDeTai.php?MaDT=".$row['MaDT']."'>Update</a></td>
                  <td type='submit'><button>Xóa</button></td>
                  </form>
                </tr>";
              }
    ...
    <div class="newsletter-section spad">
      <div class="col-sm-3">
           <button class="site-btn"><a href="../qly_cap_khoa/them_dalv_spi.php">ĐĂNG KÍ HƯỚNG DẨN ĐỒ ÁN, TIỂU LUẬN, LUẬN VĂN</a></button>
         </div>
    <div class="container">
      <div class="row">
        <form class="form-class" id="con_form">
          <table class="col-md-12">
            ...
            <?php
              ...
              echo 
                "<tr>
                  <form action='../../controllers_ad/XOADOAN.php' method='POST'>
                  ...
                  <td>".$row["MSSV"]."</td>
                  <td>".$row["QDTiet"]."</td>
                  <td><a href='../../views/qly_cap_khoa/updatedoan.php?MaDLV=".$row['MaDLV']."'>Update</a></td>
                  <td type='submit'><button>Xóa</button></td>
                  </form>
                </tr>";
              }
...
<div id="thuchanh" class="tabcontent">
  <div class="newsletter-section spad">
     <div class="col-sm-3">
          <button class="site-btn"><a href="../../views/qly_cap_khoa/insert_nhom_thuc_hanh.php">THÊM KẾ HOẠCH MỚI</a></button>
        </div>
    <div class="container">
      <div class="row">
         <form class="form-class" id="con_form">
          <table class="col-md-12">
            ...
            echo "<tr>
              <form action='../../controllers_ad/XOATH.php' method='POST'>
              <input name='id' value=".$value['MaLop']." style='display:none;'></input>
              <td>".$value["TenLopHP"]."</td>
              <td>".$value["Nhom"]."</td>
              <td>".$value["ThucHien"]."</td>
              <td><a href='../../views/qly_cap_khoa/update_thuc_hanh.php?id=".$value['MaLop']."'>Update</a></td>
              <td><button type='submit'>Xóa</button></td>
              </form>
            </tr>";
                }
